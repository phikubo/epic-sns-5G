...
def variables():
	...
	nivel=2 #nivel corresponde al nivel de coordenada hexagonal, (1.0.1) nivel 1, (2.0.1) nivel 2, etc.
...
def distancia_entre_celdas(nivel, radio_ext):
	'''Funcion que genera el valor de la distancia entre el origen y las celdas por nivel'''
	#print(radio_ext)
	r_med=radio_ext/2
	#print(r_med, nivel)
	...
	for lista in coordenadas_axiales:
		...
		for nvl in range(nivel+1):
			...
			for axial in lista:
				...
				print("x final: ", axial[0]*dec )
				print("y final: ", coord_y )
				#time.sleep(1)
...
def dibujar_celdas(cartesian_x, cartesian_y, radio_ext):
	'''Funcion principal que dibuja las celdas dadas las coordenadas de su centro.'''
	color="green"
